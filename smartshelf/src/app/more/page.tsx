  ...
  return (
    <AuthGuard>
      <div className="space-y-6">
        ...
        {/* Summary Cards */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 entrance" style={{ animationDelay: '0ms' }}>
          ...
          <Card className="glass-card rounded-2xl border-l-4 border-l-[#3b82f6] overflow-hidden entrance" style={{ animationDelay: '80ms' }}>
            <CardContent className="p-4">
        ...
        {/* Period Selector */}
        <div className="flex gap-2 entrance" style={{ animationDelay: '320ms' }}>
          {periods.map((p) => (
            <button
              key={p.value}
        ...
        {sortedBySales.length === 0 ? (
          <Card className="glass-card rounded-3xl entrance" style={{ animationDelay: '400ms' }}>
          ...
          <>
            {/* Most Sold Chart */}
            <Card className="glass-card rounded-3xl overflow-hidden entrance" style={{ animationDelay: '400ms' }}>
            ...
            {/* Sales Summary */}
            <Card className="glass-card rounded-3xl overflow-hidden entrance" style={{ animationDelay: '500ms' }}>
              <CardContent className="p-5">
        ...
        {/* Settings */}
        <Card className="glass-card rounded-3xl overflow-hidden entrance" style={{ animationDelay: '600ms' }}>
